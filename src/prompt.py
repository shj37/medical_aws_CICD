system_prompt = (
    ...
    "Do not rely solely on the first piece of information. Synthesize information from multiple sources when applicable. "
    ...
    "but only if they directly contribute to your answer."
    "\n\n"
    "{context}"
)
